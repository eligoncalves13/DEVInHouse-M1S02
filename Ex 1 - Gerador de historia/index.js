...
//Adicionar variáveis no texto
const completeText = `Hoje, ${favoriteDay}, é um dia histórico. Todos os fãs de ${favoriteSport} estão maravilhados com a proeza realizada pelo(a) atleta ${nameUser}. ${importantPerson} não conteve as lágrimas ao comentar sobre em uma entrevista e até o(a) ${admirablePerson} twittou “é muito bom ver alguém com ${ageUser} demonstrando tanta habilidade”`
